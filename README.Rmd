...
[![CRAN status](https://www.r-pkg.org/badges/version/rgph)](https://CRAN.R-project.org/package=rgph)
<!-- badges: end -->
...
**rgph** is now on [CRAN](https://cran.r-project.org/package=rgph)! You can install the latest release with:
